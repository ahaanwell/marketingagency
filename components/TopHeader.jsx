...
function TopHeader() {
  return (
    <div className="w-full bg-black text-white py-3 hidden lg:block">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 lg:gap-8">
            ...
            {/* Email */}
            <a 
              href="mailto:info@livexcellence.com" 
              className="flex items-center gap-2 hover:text-gray-300 transition-colors"
            >
              <Mail className="w-4 h-4" />
              <span>info@livexcellence.net</span>
            </a>
