  ...
  const sections = [
    {
      ...
      title: "Overview",
      content: [
        "Welcome to Livexcellence website (livexcellence.net). These terms and conditions constitute a legal agreement between you and Livexcellence. By accessing or using this website, you agree to be bound by these terms and conditions. If you do not agree to any part of these terms, please discontinue your use of this website."
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content: [
        "The website is intended to provide information about Livexcellence and its services. By using this website, you agree to adhere to these terms and to use the website only for lawful purposes. You must be of legal age to enter into a contract to use the website and its services."
      ]
    },
    {
      id: 4,
    ...
    },
    {
      ...
      content: [
        "Livexcellence makes no warranties, express or implied, regarding the accuracy, completeness, or reliability of any content, material, or services available on this website. We do not guarantee that the website will remain error-free, secure, or uninterrupted."
      ]
    },
    {
      id: 6,
      ...
      content: [
        "All content on this website is owned by Livexcellence and is protected by copyright, trademark, and other intellectual property laws. Unauthorized use, reproduction, or distribution of any content on this website is prohibited."
      ]
    },
    {
      id: 7,
    ...
    },
    {
      ...
      content: [
        "You agree to indemnify and hold Livexcellence, its affiliates, and its personnel harmless from any claims, damages, losses, liabilities, or expenses arising from your use of the website or any violation of these terms."
      ]
    },
    {
      id: 10,
      ...
      content: [
        "Livexcellence shall not be liable for any damages resulting from:"
      ],
      list: [
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                By using this website, you acknowledge that you have read, understood, and agree to these terms and conditions. These terms constitute a binding legal agreement between you and Livexcellence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-8">
          ...
          <div className="space-y-2">
            <p className="text-gray-700">
              <strong>Company:</strong> Livexcellence
            </p>
            <p className="text-gray-700">
              <strong>Website:</strong>{' '}
              <a href="https://livexcellence.net" className="text-gray-900 hover:underline">
                livexcellence.net
              </a>
            </p>
            <p className="text-gray-700">
              <strong>Email:</strong>{' '}
              <a href="mailto:info@livexcellence.net" className="text-gray-900 hover:underline">
                info@livexcellence.net
              </a>
            </p>
          </div>
        </div>
